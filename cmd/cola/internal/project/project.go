...
var CmdNew = &cobra.Command{
	...
	Long:  "Create a service project using the repository template. Example: cola new helloworld",
	Run:   run,
}
...
func init() {
	if repoURL = os.Getenv("COLA_LAYOUT_REPO"); repoURL == "" {
		repoURL = "https://github.com/wang1309/cola-layout.git"
	}
	timeout = "600s"
